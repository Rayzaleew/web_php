...
$staff_query = pg_query($dbconn, "SELECT
    ...
    INNER JOIN models ON staff.computer_id = models.id
...
<body>
    ...
    <div class="container mb-3">
        ...
        if (isset($_SESSION['userid'])) {
            echo "<a href='/lab4/logout.php' class='mb-3'>Выйти из 
                $current_staff[last_name] ($current_staff[username], $current_staff[department_name])
            </a>";
        } else {
            echo "<a href='/lab4/auth.php' class='mb-3'>Войти на сайт</a>";
        }
        ?>
        ...
        <?php
        if ($is_hr) {
            echo "<a href='/lab4/insert.php' class='mb-3 button'>
                " . $_ICONS["add"] . "
                Создать сотрудника
            </a>";
        } else {
            ...
            <tbody>
                ...
                foreach ($staff as $person) {
                    echo "<tr>
                        ...
                        " . ($is_hr ? "
                            <td><a href='/lab4/edit.php?id=" . $person['id'] . "'>
                                " . $_ICONS["edit"] . "
                            </a></td>
                        " : "") . "
