...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    if (!$staff) {
        header("Location: /lab2/index.php?error=404");
        exit();
    }
    ...
    if (!$last_name || !$room_id || !$computer_id) {
        header("Location: /lab2/edit.php?error=1&id=" . $_GET['id'] . "");
        exit();
    }
    ...
    header("Location: /lab2/edit.php?success=true&id=" . $_GET['id'] . "");
}
...
<body>
    <form class="container mb-3" method="POST">
        <a href="/lab2/index.php" class="mb-3">Вернуться к списку сотрудников</a>
        ...
        <a class="button" href="/lab2/delete.php?id=<?= $staff['id'] ?>" class="delete">Удалить сотрудника</a>
    </form>
